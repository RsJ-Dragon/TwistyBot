...
console.log = function(...args) {
	...
	console.old('[' + moment.tz('America/New_York').format('MM-DD HH:mm:ss') + ']' + chalk.blue(caller.file + ':'), message);
...
console.info = function(...args) {
	...
	console.old('[' + moment.tz('America/New_York').format('MM-DD HH:mm:ss') + ']' + chalk.blue(caller.file + ':'), chalk.gray(message));
	logfile.write(caller.file + ':' + caller.line + ': ' + strip_escapes(message) + '\n');
};
...
console.warn = function(...args) {
	...
	console.old('[' + moment.tz('America/New_York').format('MM-DD HH:mm:ss') + ']' + chalk.blue(caller.file + ':'), chalk.yellow(message));
	logfile.write(caller.file + ':' + caller.line + ': ' + strip_escapes(message) + '\n');
};
...
console.error = function(...args) {
	...
	console.old('[' + moment.tz('America/New_York').format('MM-DD HH:mm:ss') + ']' + chalk.blue(caller.file + ':'), chalk.red(message));
	logfile.write(caller.file + ':' + caller.line + ': ' + strip_escapes(message) + '\n');
};
...
console.success = function(...args) {
	...
	console.old('[' + moment.tz('America/New_York').format('MM-DD HH:mm:ss') + ']' + chalk.blue(caller.file + ':'), chalk.green(message));
	logfile.write(caller.file + ':' + caller.line + ': ' + strip_escapes(message) + '\n');
};
